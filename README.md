...
Fork the following repo `https://github.com/ocadmorg/backstage-demo` to your organization.
...
cd backstage-demo
find . -type f -not -path '*/\.git/*' -exec sed -i "s/ocadmorg/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/ocadmorg/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/cluster-6vx6d.6vx6d.sandbox979.opentlc.com/${base_domain}/g" {} +
git add -A
...
Fork the following repo `https://github.com/ocadmorg/shared-workflows` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/ocadmorg/software-templates` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/ocadmorg/backstage-app-demo` to your organization.
